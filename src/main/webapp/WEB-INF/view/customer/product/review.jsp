...
<head>
    ...
    <style>
        ...
        .star-rating label:hover ~ label {
            color: #ffcc00;
            transform: scale(1.2); /* Zoom ngôi sao khi hover */
        }
...
<body>
    <div class="fullscreen-container">
        <div class="rating-container">
            ...
            <form action="${pageContext.request.contextPath}/customer/submit-review/${orderDetail.id}" method="POST">
                ...
                <textarea id="reviewContent" name="reviewContent" rows="4" class="form-control mb-3" placeholder="Nhập đánh giá của bạn tại đây"></textarea>
    ...
    <script>
        function validateRating() {
            ...
            return true; // Cho phép gửi form nếu đã chọn
        }
    </script>
